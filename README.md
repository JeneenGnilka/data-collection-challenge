...
Use starter code: part_1_marsd_news.ipynb
...
Use the starter: part_2_mars_weather.ipynb
Use automated browsing to visit the Mars Temperature Data SiteLinks to an external site https://static.bc-edx.com/data/web/mars_facts/temperature.html.
Inspect the page to identify which elements to scrape.
